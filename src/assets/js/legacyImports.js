!(function(globals) {
  ...
  (function(globals) {
    ...
    (Criteria = function(options) {
      ...
      (Criteria.prototype.notMatch = function(val, param) {
        ...
        return (
          val_lc === param_lc && val_lc.length === param_lc.length
            ? (cssClass = this.stateFail)
            : val_lc != param_lc.substring(0, val_lc.length) && (cssClass = this.statePass),
          cssClass
        );
      }),
  ...
  (function(globals) {
    'use strict';
    (globals.DVSA.Modules.DVSACriteria = DVSACriteria), globals.DVSA.init($({}));
  })(this);
