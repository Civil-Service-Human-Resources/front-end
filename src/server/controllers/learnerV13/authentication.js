...
export function resetPasswordGet(req, res) {
  ...
  return res.render('prototypes/learner/v13/authentication/reset-password', viewData);
}
...
export function resetPasswordPost(req, res) {
  ...
  if (validateEmail(email)) {
    redirectPath = '/prototypes/learner/v13/email-sent';
  } else {
    req.session.emailError = true;
    redirectPath = '/prototypes/learner/v13/reset-password';
  }
...
export function emailSentGet(req, res) {
  let viewData;
  viewData = {};
  return res.render('prototypes/learner/v13/authentication/email-sent', viewData);
}
...
export function enterNewPasswordGet(req, res) {
  ...
  return res.render('prototypes/learner/v13/authentication/enter-new-password', viewData);
}
...
export function enterNewPasswordPost(req, res) {
  ...
  if (passwordError === true) {
    ...
    redirectPath = '/prototypes/learner/v13/enter-new-password';
  } else {
    // all good!
    redirectPath = '/prototypes/learner/v13/reset-success';
  }
...
export function resetSuccessGet(req, res) {
  let viewData;
  viewData = {};
  return res.render('prototypes/learner/v13/authentication/reset-success', viewData);
}
...
export function createNewPasswordGet(req, res) {
  ...
  return res.render('prototypes/learner/v13/authentication/create-new-password', viewData);
}
...
export function createNewPasswordPost(req, res) {
  ...
  if (passwordError === true) {
    ...
    req.session.passwordErrorInputMessageOne = passwordErrorInputMessageOne;
    req.session.passwordErrorInputMessageTwo = passwordErrorInputMessageTwo;
    redirectPath = '/prototypes/learner/v13/create-new-password';
  } else {
    // all good!
    redirectPath = '/prototypes/learner/v13/create-success';
  }
...
export function createSuccessGet(req, res) {
  let viewData;
  viewData = {};
  return res.render('prototypes/learner/v13/authentication/create-success', viewData);
}
