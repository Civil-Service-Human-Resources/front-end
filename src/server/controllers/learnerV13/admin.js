...
export function adminGet(req, res) {
  ...
  return res.render('prototypes/learner/v13/admin/index', viewData);
}
export function adminPost(req, res) {
  ...
  if (eventsSubmit == 'events') {
    redirectPath = '/prototypes/learner/v13/admin/events-list';
  } else if (courseSubmit == 'courses') {
    redirectPath = '/prototypes/learner/v13/admin/course-list';
  } else {
    redirectPath = '/prototypes/learner/v13/admin';
  }
...
export function adminCourseListGet(req, res) {
  ...
  return res.render('prototypes/learner/v13/admin/course-list', viewData);
}
export function adminCourseListPost(req, res) {
  const {} = req.body;

  return res.redirect('/prototypes/learner/v13/admin');
}
...
export function adminEventsListGet(req, res) {
  ...
  return res.render('prototypes/learner/v13/admin/events-list', viewData);
}
...
export function adminEditGet(req, res) {
  ...
  return res.render('prototypes/learner/v13/admin/edit', viewData);
}
...
export function adminAddGet(req, res) {
  ...
  return res.render('prototypes/learner/v13/admin/add', viewData);
}
export function adminAddPost(req, res) {
  const {} = req.body;

  return res.redirect('/prototypes/learner/v13/admin/add-details');
}
...
export function adminAddDetailsGet(req, res) {
  ...
  return res.render('prototypes/learner/v13/admin/add-details', viewData);
}
export function adminAddDetailsPost(req, res) {
  ...
  if (addRowEvent == 'addRow') {
    ...
    return res.redirect('/prototypes/learner/v13/admin/add-assets');
  }
}
...
export function adminAddAssetsGet(req, res) {
  ...
  return res.render('prototypes/learner/v13/admin/add-assets', viewData);
}
export function adminAddAssetsPost(req, res) {
  const {} = req.body;

  return res.redirect('/prototypes/learner/v13/admin/add-review');
}
...
export function adminAddReviewGet(req, res) {
  ...
  return res.render('prototypes/learner/v13/admin/add-review', viewData);
}
export function adminAddReviewPost(req, res) {
  const {} = req.body;

  return res.redirect('/prototypes/learner/v13/add-complete');
}
