...
let allOrgsAndSubDivisions = [
  ...
  'Crown Prosecution Service, CPS,  Central Casework Group',
  'Crown Prosecution Service, CPS, CPS Direct',
  'Crown Prosecution Service, CPS, CPSPOC',
  'Crown Prosecution Service, CPS, Crown Prosecution Service, CPS, Inspectorate',
  'Crown Prosecution Service, CPS, Cymru/Wales',
  'Crown Prosecution Service, CPS, East Midlands',
  'Crown Prosecution Service, CPS, East of England',
  'Crown Prosecution Service, CPS, HQ BIS',
  'Crown Prosecution Service, CPS, HQ Communication',
  'Crown Prosecution Service, CPS, HQ Corporate Services',
  'Crown Prosecution Service, CPS, HQ Operations',
  'Crown Prosecution Service, CPS, HQ PAID',
  'Crown Prosecution Service, CPS, HQ Private Office',
  'Crown Prosecution Service, CPS, HQ SPD',
  'Crown Prosecution Service, CPS, International Division',
  'Crown Prosecution Service, CPS, Merseyside & Cheshire',
  'Crown Prosecution Service, CPS, North East',
  'Crown Prosecution Service, CPS, North London',
  'Crown Prosecution Service, CPS, North West',
  'Crown Prosecution Service, CPS, Organised Crime Division',
  'Crown Prosecution Service, CPS, South East',
  'Crown Prosecution Service, CPS, South London',
  'Crown Prosecution Service, CPS, South West',
  'Crown Prosecution Service, CPS, Special Crime and Counter Terrorism Division',
  'Crown Prosecution Service, CPS, Specialist Fraud',
  'Crown Prosecution Service, CPS, Thames and Chiltern',
  'Crown Prosecution Service, CPS, Wessex',
  'Crown Prosecution Service, CPS, West Midlands',
  'Crown Prosecution Service, CPS, Yorkshire & Humberside',
  'CSR Managed Fast Stream',
  'Debt Management Office',
  'Department for Business, Energy & Industrial Strategy, BEIS',
  'Department for Business, Energy & Industrial Strategy, BEIS, ACAS',
  'Department for Business, Energy & Industrial Strategy, BEIS, Business & Science',
  'Department for Business, Energy & Industrial Strategy, BEIS, Companies House',
  'Department for Business, Energy & Industrial Strategy, BEIS, Energy & Security',
  'Department for Business, Energy & Industrial Strategy, BEIS, Energy Transformation',
  'Department for Business, Energy & Industrial Strategy, BEIS, Finance & Corporate Services',
  'Department for Business, Energy & Industrial Strategy, BEIS, Finance, Commercial and Digital Transformation',
  'Department for Business, Energy & Industrial Strategy, BEIS, Financial Reporting Council',
  'Department for Business, Energy & Industrial Strategy, BEIS, HM Land Registry',
  'Department for Business, Energy & Industrial Strategy, BEIS, Insolvency Service',
  'Department for Business, Energy & Industrial Strategy, BEIS, Intellectual Property Office',
  'Department for Business, Energy & Industrial Strategy, BEIS, International, Growth and Analysis',
  'Department for Business, Energy & Industrial Strategy, BEIS, Market Frameworks',
  'Department for Business, Energy & Industrial Strategy, BEIS, Met Office',
  'Department for Business, Energy & Industrial Strategy, BEIS, MPST',
  'Department for Business, Energy & Industrial Strategy, BEIS, Office of Manpower Economics',
  'Department for Business, Energy & Industrial Strategy, BEIS, Ordnance Survey',
  'Department for Business, Energy & Industrial Strategy, BEIS, Shareholder Executive',
  'Department for Business, Energy & Industrial Strategy, BEIS, UK Space Agency',
  ...
  'Department for Transport, Dft, Driver and Vehicle Licensing Agency DVLA',
  'Department for Transport, Dft, Highways Agency',
  'Department for Transport, Dft, Maritime and Coastguard Agency',
  'Department for Transport, Dft, Office of the Traffic Commissioner',
  'Department for Transport, Dft, Vehicle & Operator Services Agency VOSA',
  'Department for Transport, Dft, Vehicle Certification Agency',
  ...
  'HM Revenue & Customs, HMRC, Benefits & Credits',
  'HM Revenue & Customs, HMRC, Business Tax',
  'HM Revenue & Customs, HMRC, Central Tax and Strategy Group',
  'HM Revenue & Customs, HMRC, Chief Digital and Information Officer Group',
  'HM Revenue & Customs, HMRC, Chief Executive and Permanent Secretary',
  "HM Revenue & Customs, HMRC, Chief Finance Officer's Group",
  'HM Revenue & Customs, HMRC, Enforcement & Compliance',
  'HM Revenue & Customs, HMRC, HM Revenue & Customs, HMRC, ',
  'HM Revenue & Customs, HMRC, Human Resources',
  'HM Revenue & Customs, HMRC, Legal and Accountants',
  'HM Revenue & Customs, HMRC, Personal Tax',
  'HM Revenue & Customs, HMRC, Revenue and Customs Digital and Technology Services',
  'HM Revenue & Customs, HMRC, Valuation Office',
  'HM Treasury',
  ...
  'Ministry of Defence, MOD, Air Command',
  'Ministry of Defence, MOD, Army Command',
  'Ministry of Defence, MOD, Defence Business Services',
  'Ministry of Defence, MOD, Defence Electronics & Components Agency',
  'Ministry of Defence, MOD, Defence Equipment and Support',
  'Ministry of Defence, MOD, Defence Science & Technology Laboratory',
  'Ministry of Defence, MOD, DIO',
  'Ministry of Defence, MOD, Head Office & Corporate Services',
  'Ministry of Defence, MOD, JFC',
  'Ministry of Defence, MOD, Navy Command',
  'Ministry of Defence, MOD, Nuclear',
  'Ministry of Defence, MOD, Submarine Delivery Agency (SDA)',
  'Ministry of Defence, MOD, UK Hydrographic Office',
  ...
  'Ministry of Justice, MOJ, CICA',
  'Ministry of Justice, MOJ, Finance, Analysis and Commercial',
  'Ministry of Justice, MOJ, HMCTS',
  'Ministry of Justice, MOJ, LAA',
  'Ministry of Justice, MOJ, NOMS',
  'Ministry of Justice, MOJ, Operations',
  'Ministry of Justice, MOJ, OPG',
  'Ministry of Justice, MOJ, Policy',
  'Ministry of Justice, MOJ, Prison Reform and Youth Justice Policy',
