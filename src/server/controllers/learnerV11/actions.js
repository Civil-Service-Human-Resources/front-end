...
export function actionsGet(req, res) {
  ...
  if (action === 'addedToLearningPlan') {
    ...
    redirectPath = '/prototypes/learner/v11/home';
  }
  ...
  if (action === 'completeFireTraining' && id === '15') {
    ...
    redirectPath = '/prototypes/learner/v11/scorms/basic-fire-safety/complete';
  }
  ...
  if (action == 'workAreaHasBeenUpdated') {
    ...
    redirectPath = '/prototypes/learner/v11/your-profile';
  }
  ...
  if (action == 'showPreFilteredResults') {
    ...
    redirectPath = '/prototypes/learner/v11/search';
  }
...
export function actionsPost(req, res) {
  ...
  /*if (action === 'addedToLearningPlan') {
          ...
          redirectPath = '/prototypes/learner/v11/suggested-learning';
      }*/
