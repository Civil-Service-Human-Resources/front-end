...
export function homeGet(req, res) {
  ...
  return res.render('prototypes/learner/v11/home/index', viewData);
}
...
export function plannedGet(req, res) {
  ...
  return res.render('prototypes/learner/v11/learning-plan/index', viewData);
}
...
export function profileGet(req, res) {
  ...
  return res.render('prototypes/learner/v11/profile/index', viewData);
}
...
export function recordGet(req, res) {
  ...
  return res.render('prototypes/learner/v11/learning-record/index', viewData);
}
...
export function suggestedGet(req, res) {
  ...
  if (type == 'accordion') {
    templateVersion = 'prototypes/learner/v11/suggested-learning/index-boxed';
  } else if (type == 'squares') {
    templateVersion = 'prototypes/learner/v11/suggested-learning/index-squares';
  } else {
    templateVersion = 'prototypes/learner/v11/suggested-learning/index';
  }
...
export function suggestedFullGet(req, res) {
  let viewData;
  viewData = {};
  return res.render('prototypes/learner/v11/suggested-learning/full', viewData);
}
...
export function suggestedAllGet(req, res) {
  let viewData;
  viewData = {};
  return res.render('prototypes/learner/v11/suggested-learning/all', viewData);
}
...
export function suggestedAllHMRCGet(req, res) {
  let viewData;
  viewData = {};
  return res.render('prototypes/learner/v11/suggested-learning/hmrc', viewData);
}
...
export function suggestedAllHMRCColsGet(req, res) {
  let viewData;
  viewData = {};
  return res.render('prototypes/learner/v11/suggested-learning/hmrc-cols', viewData);
}
...
export function searchGet(req, res) {
  ...
  return res.render('prototypes/learner/v11/search/index', viewData);
}
...
export function searchPost(req, res) {
  ...
  return res.redirect('/prototypes/learner/v11/search');
}
...
export function feedbackGet(req, res) {
  ...
  return res.render('prototypes/learner/v11/feedback/index', viewData);
}
...
export function feedbackPost(req, res) {
  ...
  redirectPath = '/prototypes/learner/v11/learning-record';
...
export function privacyGet(req, res) {
  let viewData;
  viewData = {};
  return res.render('prototypes/learner/v11/privacy/index', viewData);
}
...
export function feedbackFormalGet(req, res) {
  ...
  return res.render('prototypes/learner/v11/feedback/formal', viewData);
}
...
export function feedbackInformalGet(req, res) {
  ...
  return res.render('prototypes/learner/v11/feedback/informal', viewData);
}
