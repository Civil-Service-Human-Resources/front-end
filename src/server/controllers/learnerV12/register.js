...
export function registerEmailGet(req, res) {
  ...
  return res.render('prototypes/learner/v12/registration/index', viewData);
}
...
export function registerEmailPost(req, res) {
  ...
  if (registrationEmailError === true) {
    ...
    return res.redirect('/prototypes/learner/v12/registration');
  } else {
    req.session.registrationEmailError = req.session.registrationEmailErrorMessage = null;
    if (editMode === true) {
      req.session.editMode = null;
      return res.redirect('/prototypes/learner/v12/registration/review');
    } else {
      return res.redirect('/prototypes/learner/v12/registration/personal-details');
    }
  }
}
// **************************************************************************************
...
export function registerPersonalGet(req, res) {
  ...
  return res.render('prototypes/learner/v12/registration/personal-details/index', viewData);
}
...
export function registerPersonalPost(req, res) {
  ...
  if (registrationPersonalError === true) {
    ...
    if (editMode === true) {
      ...
      return res.redirect('/prototypes/learner/v12/registration/department');
    }
  }
}
// **************************************************************************************
...
export function registerDepartmentGet(req, res) {
  ...
  return res.render('prototypes/learner/v12/registration/department/index', viewData);
}
...
export function registerDepartmentPost(req, res) {
  ...
  if (parseInt(department) < 1) {
    ...
    if (editMode === true) {
      ...
      // return res.redirect('/prototypes/learner/v12/registration/area-of-work');
      return res.redirect('/prototypes/learner/v12/registration/grade');
    }
  }
}
// **************************************************************************************
...
export function registerAreaGet(req, res) {
  ...
  return res.render('prototypes/learner/v12/registration/area-of-work/index', viewData);
}
  ...
  if (registrationJob2Error === true) {
    ...
    if (editMode === true) {
      ...
      if (usersProfession === 'Operational delivery') {
        return res.redirect('/prototypes/learner/v12/registration/area-of-work/details');
      } else {
        return res.redirect('/prototypes/learner/v12/registration/other-areas');
      }
    }
  }
}
...
export function registerAreaDetailsGet(req, res) {
  ...
  if (professionName === 'Operational delivery') {
    viewPath = 'prototypes/learner/v12/registration/area-of-work/details-opsdel';
  } else if (professionName === 'Digital, Data and Technology') {
    viewPath = 'prototypes/learner/v12/registration/area-of-work/details-ddat';
  } else {
    return res.redirect('/prototypes/learner/v12/registration/other-areas');
  }
...
export function registerInterestsGet(req, res) {
  ...
  return res.render('prototypes/learner/v12/registration/interests/index', viewData);
}
// Job2 details: POST
export function registerInterestsPost(req, res) {
  ...
  if (editMode === true) {
    ...
    return res.redirect('/prototypes/learner/v12/registration/password');
  }
}
...
export function registerOtherAreasGet(req, res) {
  ...
  return res.render('prototypes/learner/v12/registration/other-areas/index', viewData);
}
// Job2 details: POST
export function registerOtherAreasPost(req, res) {
  ...
  if (registrationJob2Error === true) {
    ...
    if (editMode === true) {
      ...
      // return res.redirect('/prototypes/learner/v12/registration/grade');
      return res.redirect('/prototypes/learner/v12/registration/interests');
    }
  }
}
...
export function registerGradeGet(req, res) {
  ...
  return res.render('prototypes/learner/v12/registration/grade/index', viewData);
}
...
export function registerPasswordGet(req, res) {
  ...
  return res.render('prototypes/learner/v12/registration/password/index', viewData);
}
...
export function registerReviewGet(req, res) {
  ...
  return res.render('prototypes/learner/v12/registration/review/index', viewData);
}
...
export function registerReviewPost(req, res) {
  ...
  return res.redirect('/prototypes/learner/v12/registration/complete');
}
// **************************************************************************************
// Complete GET
// **************************************************************************************
export function registerCompleteGet(req, res) {
  ...
  return res.render('prototypes/learner/v12/registration/complete/index', viewData);
}
