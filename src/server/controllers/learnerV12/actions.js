...
export function actionsGet(req, res) {
  ...
  if (action === 'addedToLearningPlan') {
    ...
    redirectPath = '/prototypes/learner/v12/home';
  }
  ...
  if (action === 'completeFireTraining' && id === '15') {
    ...
    redirectPath = '/prototypes/learner/v12/scorms/basic-fire-safety/complete';
  }
  ...
  if (action == 'workAreaHasBeenUpdated') {
    ...
    redirectPath = '/prototypes/learner/v12/your-profile';
  }
  ...
  if (action == 'showPreFilteredResults') {
    ...
    redirectPath = '/prototypes/learner/v12/search';
  }
...
export function actionsPost(req, res) {
  ...
  /*if (action === 'addedToLearningPlan') {
          ...
          redirectPath = '/prototypes/learner/v12/suggested-learning';
      }*/
