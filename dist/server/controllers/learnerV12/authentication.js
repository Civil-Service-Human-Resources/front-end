...
function resetPasswordGet(req, res) {
  ...
  return res.render('prototypes/learner/v12/authentication/reset-password', viewData);
}
...
function resetPasswordPost(req, res) {
  ...
  if ((0, _validationFunctions.validateEmail)(email)) {
    redirectPath = '/prototypes/learner/v12/email-sent';
  } else {
    req.session.emailError = true;
    redirectPath = '/prototypes/learner/v12/reset-password';
  }
...
function emailSentGet(req, res) {
  let viewData;
  viewData = {};
  return res.render('prototypes/learner/v12/authentication/email-sent', viewData);
}
...
function enterNewPasswordGet(req, res) {
  ...
  return res.render('prototypes/learner/v12/authentication/enter-new-password', viewData);
}
...
function enterNewPasswordPost(req, res) {
  ...
  if (passwordError === true) {
    ...
    redirectPath = '/prototypes/learner/v12/enter-new-password';
  } else {
    // all good!
    redirectPath = '/prototypes/learner/v12/reset-success';
  }
...
function resetSuccessGet(req, res) {
  let viewData;
  viewData = {};
  return res.render('prototypes/learner/v12/authentication/reset-success', viewData);
}
...
function createNewPasswordGet(req, res) {
  ...
  return res.render('prototypes/learner/v12/authentication/create-new-password', viewData);
}
...
function createNewPasswordPost(req, res) {
  ...
  if (passwordError === true) {
    ...
    req.session.passwordErrorInputMessageOne = passwordErrorInputMessageOne;
    req.session.passwordErrorInputMessageTwo = passwordErrorInputMessageTwo;
    redirectPath = '/prototypes/learner/v12/create-new-password';
  } else {
    // all good!
    redirectPath = '/prototypes/learner/v12/create-success';
  }
...
function createSuccessGet(req, res) {
  let viewData;
  viewData = {};
  return res.render('prototypes/learner/v12/authentication/create-success', viewData);
}