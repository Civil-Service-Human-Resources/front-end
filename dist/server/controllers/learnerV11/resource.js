...
function resourceGet(req, res) {
  ...
  if ((0, _validationFunctions.isNumeric)(parseInt(resourceID))) {
    returnPath = 'prototypes/learner/v11/resource/' + resourceID;
  } else if (availableTypes.includes(resourceType)) {
    returnPath = 'prototypes/learner/v11/resource/' + resourceType;
  } else {
    returnPath = 'prototypes/learner/v11/resource/index';
  }
...
function resourcePost(req, res) {
  ...
  if (resourceID === '15') {
    return res.redirect('/prototypes/learner/v11/scorms/basic-fire-safety');
  } else {
