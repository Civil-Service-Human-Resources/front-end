...
function indexGet(req, res) {
  ...
  // return res.render('prototypes/learner/v11/index', { loggedOut: false });
  ...
  return res.render('prototypes/learner/v11/index', viewData);
}
...
function indexPost(req, res) {
  ...
  if ((0, _validationFunctions.validateEmail)(email) && password.length >= 2) {
    return res.redirect('/prototypes/learner/v11/home');
  } else if (email == 'admin') {
